...
const F = {
  ...
  imm5708: { key: 'imm5708', label: 'IMM 5708 — Visitor Record / TRV (inside Canada)' },
...
export const APP_TYPES = {
  ...
  'trv-inside': {
    key: 'trv-inside', title: 'Visitor Visa / Visitor Record (inside Canada)', group: 'Visit', where: 'inside',
    description: 'Permit holder inside Canada applying for a TRV or extending visitor status.',
    steps: ['personal', 'passport', 'contact', 'family', 'statusInCanada', 'visit', 'history', 'finances'],
    forms: [F.imm5257, F.imm5645, F.imm5476],
    checklist: [DOC.passport, DOC.photo, DOC.statusInCanada, DOC.lastEntry, DOC.employment, DOC.marriage, DOC.birthCert, DOC.funds, DOC.refusal],
