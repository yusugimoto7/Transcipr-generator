...
SERVICES = {
    ...
    # --- Study ----------------------------------------------------------------
    "SP-ADM": dict(cat="study", en="Study permit application (college / university)",
                   fa="مجوز تحصیل (کالج / دانشگاه)", price=2200,
    ...
    "SP-ADM-K12": dict(cat="study", en="Study permit application (school student)",
                       fa="مجوز تحصیل دانش‌آموزی", price=2200,
    ...
    "SPX": dict(cat="study", en="Study permit extension", fa="تمدید مجوز تحصیل", price=700, gov=[],
                terms_en="Full amount plus government fees at signing.",
    ...
    "IN-TRV": dict(cat="permit", en="In-Canada visitor visa (permit holders)", fa="ویزای توریستی داخل کانادا",
                   ...
                   terms_en="Full amount plus government fees at signing.",
                   terms_fa="کل مبلغ + هزینه دولتی همراه با امضا."),
    "VR": dict(cat="permit", en="Visitor record", fa="ویزیتور ریکورد", price=700, gov=[],
