...
const CORE_FEEDS = [
  ...
  // Google News — aggregates many outlets and is the freshest free source.
  // `when:7d` restricts results to the last 7 days at the query level.
  {
    url: "https://news.google.com/rss/search?q=%22canada%20immigration%22%20when%3A7d&hl=en-CA&gl=CA&ceid=CA:en",
    name: "Google News",
  },
  {
    url: "https://news.google.com/rss/search?q=(IRCC%20OR%20PGWP%20OR%20%22work%20permit%22%20OR%20%22study%20permit%22%20OR%20PNP)%20canada%20when%3A7d&hl=en-CA&gl=CA&ceid=CA:en",
    name: "Google News",
  },
];
