...
For each KEPT item, write a card in the brand's voice: punchy, high-stakes/anxiety framing where honest, name "Iranians" directly when it fits, specific not generic — but ONLY using what the article actually says. Keep the best (up to 8; fewer is fine).
...
// Curated evergreen how-to topics (not tied to a news event) with real official
// source links. Used to round out the deck alongside fresh news. Written in the
// brand's Farsi voice.
export const EVERGREEN_TOPICS = [
  { title_fa: "بعد از انقضای PGWP چطور قانونی در کانادا بمونیم؟", title_en: "How to legally stay in Canada after your PGWP expires", field: "Study", page: "CA", why_now: "بزرگ‌ترین دغدغهٔ دانشجوهای بین‌المللی؛ همیشه پرجست‌وجو و پراضطراب.", source_url: "https://www.canada.ca/en/immigration-refugees-citizenship/services/study-canada/work/after-graduation.html", score: 86 },
  { title_fa: "از ورک‌پرمیت به اقامت دائم — مسیرها و شرط‌ها", title_en: "From work permit to PR — the real pathways", field: "Work Permit", page: "CA", why_now: "پرتکرارترین سؤال دارندگان ورک‌پرمیت؛ تقاضای دائمی داره.", source_url: "https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada.html", score: 84 },
  { title_fa: "بزرگ‌ترین اشتباهاتی که باعث ریجکت پرونده می‌شن", title_en: "The biggest mistakes that get an application refused", field: "Policy", page: "CA", why_now: "ترس از ریجکتی همیشه بین متقاضیان زنده‌ست.", source_url: "https://www.canada.ca/en/immigration-refugees-citizenship/services/application/account.html", score: 83 },
  { title_fa: "کدوم شغل‌ها توی BC PNP بیشترین شانس رو دارن؟", title_en: "Which jobs get the best odds in BC PNP?", field: "PNP", page: "CA", why_now: "فضای BC PNP برای مخاطب فارسی نیمه‌خالیه و شما همون‌جایید.", source_url: "https://www.welcomebc.ca/immigrate-to-b-c/b-c-provincial-nominee-program", score: 82 },
  { title_fa: "LMIA چیه و چطور شانس تأییدش رو بالا ببریم؟", title_en: "What is an LMIA and how to boost your approval odds", field: "LMIA", page: "CA", why_now: "گلوگاه خیلی از پرونده‌های کاری همینه.", source_url: "https://www.canada.ca/en/employment-social-development/services/foreign-workers.html", score: 80 },
  { title_fa: "کارت فرصت آلمان: سه اشتباهی که پرونده‌تو رد می‌کنه", title_en: "Germany Opportunity Card: 3 mistakes that get you rejected", field: "Europe", page: "EU", why_now: "لِین اروپا برای مخاطب فارسی تقریباً بی‌رقیبه.", source_url: "https://www.make-it-in-germany.com/en/visa-residence/types/opportunity-card", score: 80 },
  { title_fa: "اثبات تمکن مالی برای ویزای کانادا — چقدر و چطور؟", title_en: "Proof of funds for Canada — how much and how", field: "Policy", page: "CA", why_now: "یکی از رایج‌ترین دلایل نقص مدارک و ریجکتی.", source_url: "https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/documents/proof-funds.html", score: 78 },
  { title_fa: "تفاوت ویزای توریستی، سوپر ویزا و اقامت — کدوم برای شما؟", title_en: "Visitor visa vs Super Visa vs PR — which fits you?", field: "Policy", page: "CA", why_now: "سردرگمی همیشگی خانواده‌ها بین این مسیرها.", source_url: "https://www.canada.ca/en/immigration-refugees-citizenship/services/visit-canada.html", score: 77 },
];
